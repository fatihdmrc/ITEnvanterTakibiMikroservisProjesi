...
{
    Task<IReadOnlyCollection<Cihaz>> FiltreleAsync(Guid? kategoriId = null, Guid? lokasyonId = null, bool? aktifMi = null, CihazDurumu? durum = null, string? arama = null, CancellationToken cancellationToken = default);
    ...
    Task<int> SonAssetTagSiraNumarasiAsync(CancellationToken cancellationToken = default);
